...
ROOT = Path(
    ...
    "silverpond-bubble-fish"
)
ACTION_WINDOWS = {
    "idle": {"start": 0, "end": 48, "expected": 13},
    "attack": {"start": 8, "end": 32, "expected": 7},
...
def conservative_key(source: Image.Image, model_alpha_u8: np.ndarray) -> Image.Image:
    ...
    # Preserve the generated video's palette. Only soft boundary pixels with
    # obvious green excess receive a local despill; opaque cyan fins and the
    # pale transparent water remain untouched.
